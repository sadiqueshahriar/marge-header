						...
						<b-form @submit="onSubmit">
							...
							<b-form @submit="onSubmit">
								<b-form-row>
									...
									<b-input id="feedback-user" v-model="userId" :state="userValidation"></b-input>
							...
							<b-form @submit="onSubmit">
								<b-form-row class="mt-3">
									...
									<b-input id="feedback-pass" v-model="userPass" :state="passValidation" type="password"></b-input>
...
export default {
	...
	methods : {
		...
		async onSubmit(evt) {
			evt.preventDefault()
			const loginReq = await apiReq(this, 'login', { username: this.userId,
